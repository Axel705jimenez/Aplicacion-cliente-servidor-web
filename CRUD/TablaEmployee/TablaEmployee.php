...
<?php
    ...
    while ($registro = $datos->fetch_assoc())
    {
        ...
        <form action='EliminarEmployee.php' method='post' onsubmit=\"return confirm('¿Estás seguro de que deseas eliminar esta Employee?')\">
            <input type='hidden' name='idEmployee' value='".$registro["idEmployee"]."'>
            <button class='btn btn-danger' type='submit' name='eliminar_".$registro["idEmployee"]."'><i class='fas fa-trash-alt'></i> </button>        </form>
        <form action='ActualizarEmployee.php' method='post'>
            <input type='hidden' name='idEmployee' value='".$registro["idEmployee"]."'>
            <button class='btn btn-warning' type='submit' name='modificar_".$registro["idEmployee"]."'><i class='fas fa-edit'></i> </button>        </form>
        </div>
...
<div class="button-containerr">
  <form action="RegistrarEmployee.php" method="get">
